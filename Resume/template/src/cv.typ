...
#let _header-styles(header-font, regular-colors, accent-color, header-info-font-size) = (
  ...
  last-name: (str) => text(font: header-font, size: 26pt, weight: "bold", str),
...
#let _make-header-info(personal-info, icons) = {
  ...
  for (k, v) in personal-info {
    ...
    if k.contains("custom") {
      ...
      box({
        // Adds icons and hyperlinks (icon + text both clickable)
        if k == "email" {
          link("mailto:" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "linkedin" {
          link("https://www.linkedin.com/in/" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "github" {
          link("https://github.com/" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "gitlab" {
          link("https://gitlab.com/" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "homepage" {
          link("https://" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "orcid" {
          link("https://orcid.org/" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "researchgate" {
          link("https://www.researchgate.net/profile/" + v)[#icons.at(k) #h(3pt) #v]
        } else if k == "phone" {
          link("tel:" + v.replace(" ",""))[#icons.at(k) #h(3pt) #v]
        } else {
          icons.at(k)
          h(3pt)
          v
...
#let _make-cv-entry(
  ...
  if entry-type == "full" {
    ...
    // Check if society/location are empty to use compact single-row layout
    let society-empty = society == none or society == [] or society == ""
    let location-empty = location == none or location == [] or location == ""
    ...
    table(
      ...
      table(
          ...
          // Compact layout when society is empty
          if society-empty {
            (styles.a1)(title)
          } else {
            table(
      ...
      // Compact layout when location is empty
      if location-empty {
